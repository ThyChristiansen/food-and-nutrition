...
(function () {
  ...
  function Ta(k, m, w) {
    "millisecond" === w ? k.setMilliseconds(k.getMilliseconds() + 1 * m) : "second" === w ? k.setSeconds(k.getSeconds() + 1 * m) : "minute" === w ? k.setMinutes(k.getMinutes() + 1 * m) : "hour" === w ? k.setHours(k.getHours() + 1 * m) : "day" === w ? k.setDate(k.getDate() + 1 * m) : "week" === w ? k.setDate(k.getDate() + 7 * m) : "month" === w ? k.setMonth(k.getMonth() + 1 * m) : "year" === w && k.setFullYear(k.getFullYear() + 1 * m);
    return k;
  }
  ...
  function Ua(k, m, w) {
    ...
    if (isNaN(u)) {
      try {
        k = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" + k + "; font-size:" + m + "px; font-weight:" + w + ";";
  ...
  function N(k, m) {
    ...
    }[k || "solid"]) for (var s = 0; s < w.length; s++) {
      w[s] *= m;
    } else w = [];
    return w;
  }
  ...
  function V(k, m, w, u, y) {
    ...
    u.push([k, m, w, y]);
    return k.addEventListener ? (k.addEventListener(m, w, y), w) : k.attachEvent ? (u = function u(m) {
      m = m || window.event;
  ...
  function Ja(k, m, w) {
    if (u && Xa) {
      ...
      k.width = m * ga;
      k.height = w * ga;
      Oa !== Ka && (k.style.width = m + "px", k.style.height = w + "px", s.scale(ga, ga));
  ...
  function fb(k) {
    if (!gb) {
      var m = !1,
          w = !1;
      "undefined" === typeof oa.Chart.creditHref ? (k.creditHref = Y("iuuqr;..b`ow`rkr/bnl."), k.creditText = Y("B`ow`rKR/bnl")) : (m = k.updateOption("creditText"), w = k.updateOption("creditHref"));
  ...
  function ta(k, m, w) {
    m.getAttribute("state") || (m.style.backgroundColor = k.toolbar.backgroundColor, m.style.color = k.toolbar.fontColor, m.style.border = "none", na(k, m, {
      WebkitUserSelect: "none",
      MozUserSelect: "none",
      msUserSelect: "none",
      userSelect: "none"
    }));
    m.getAttribute("state") !== w && (m.setAttribute("state", w), m.setAttribute("type", "button"), na(k, m, {
      padding: "5px 12px",
      cursor: "pointer",
      "float": "left",
      width: "40px",
      ...
      lineHeight: "0"
    }), m.setAttribute("title", k._cultureInfo[w + "Text"]), m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + hb[w].image + "' alt='" + k._cultureInfo[w + "Text"] + "' />");
  }
  ...
  function Pa(k, m, w, s, u) {
    if (null === k || "undefined" === typeof k) return "undefined" === typeof w ? m : w;
  ...
  function wa(k, m) {
    ...
    if (s(this.options.margin) && k.options.subtitles) for (var w = k.options.subtitles, u = 0; u < w.length; u++) {
  ...
  var Ea = !1,
    ...
    colorSet3: "#c37d52ec #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")
  },
      I,
      aa,
      T,
  ...
  (function () {
    ...
    J.pro = {
      sCH: oa[J.fSDec("Bi`su")][J.fSDec("bsdehuIsdg")]
    };

    J._fTWm = function (k) {
      if ("undefined" === typeof J.pro.sCH && !$a) try {
  ...
  var db = function () {
    ...
    for (Q = E = L = J = N = 0; 0 < M.length;) {
      if (m = M.pop(), "#" === m || "0" === m) {
        if (N++, N === P) {
          var X = D,
              D = [];
          if ("0" === m) for (m = P - J - (X ? X.length : 0); 0 < m;) {
            X.unshift("0"), m--;
          }

          for (; 0 < X.length;) {
            w = X.pop() + w, Q++, 0 === Q % E && L === V && 0 < X.length && (w = y + w);
          }
        } else 0 < D.length ? (w = D.pop() + w, J++, Q++) : "0" === m && (w = "0" + w, J++, Q++), 0 === Q % E && L === V && 0 < D.length && (w = y + w);
      } else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++, E = Q, Q = 0, 0 < D.length && (w = y + w)) : w = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + w : m + w : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function (a) {
        return $(W, a.length);
      }));
    }
    ...
    for (M = !1; 0 < I.length;) {
      m = I.shift(), "#" === m || "0" === m ? 0 < k.length && 0 !== Number(k.join("")) ? (y += k.shift(), M = !0) : "0" === m && (y += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""), y += m.replace(/[0]+/, function (a) {
        return $(W, a.length);
      }));
    }
    ...
    var m = 0,
        w = 0;
    k = k || window.event;
    k.offsetX || 0 === k.offsetX ? (m = k.offsetX, w = k.offsetY) : k.layerX || 0 == k.layerX ? (m = k.layerX, w = k.layerY) : (m = k.pageX - k.target.offsetLeft, w = k.pageY - k.target.offsetTop);
    return {
      x: m,
      y: w
    };
      ...
      Ka = 1,
      ga = Xa ? Oa / Ka : 1,
      ca = function ca(k, m, w, s, u, y, D, E, N, M, Q, P, I) {
    ...
    !0 === M && (k.save(), k.beginPath(), k.moveTo(m, u), k.lineTo(m + J, u - J), k.lineTo(s - J, u - J), k.lineTo(s, u), k.closePath(), D = k.createLinearGradient((s + m) / 2, u - J, (s + m) / 2, u), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, .4)"), k.fillStyle = D, k.fill(), k.restore());
    ...
    !0 === P && (k.save(), k.beginPath(), k.moveTo(s, w), k.lineTo(s - J, w + J), k.lineTo(s - J, u - J), k.lineTo(s, u), D = k.createLinearGradient(s - J, (u + w) / 2, s, (u + w) / 2), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, k.fill(), k.closePath(), k.restore());
  },
      Y = function Y(k) {
    for (var m = "", s = 0; s < k.length; s++) {
      m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(s));
    }

    return m;
  },
      $a = window && window[Y("mnb`uhno")] && window[Y("mnb`uhno")].href && window[Y("mnb`uhno")].href.indexOf && (-1 !== window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))),
  ...
  W.prototype.setOptions = function (k, m) {
    if (oa[this._defaultsKey]) {
      ...
      for (u in s) {
        "publicProperties" !== u && s.hasOwnProperty(u) && (this[u] = k && u in k ? k[u] : m && u in m ? m[u] : s[u]);
      }
  ...
  W.prototype.createUserOptions = function (k) {
    if ("undefined" !== typeof k || this.options._isPlaceholder) if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
      ...
      m[s] = this.options;
    } else this.options = "undefined" === typeof k ? {} : k, k = this.parent.options, this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (s = m.charAt(0).toLowerCase(), 1 < m.length && (s = s.concat(m.slice(1))), m = s) : m = void 0, k[m] = this.options;
  };
  ...
  W.prototype.addEventListener = function (k, m, s) {
    k && m && (this._eventListeners[k] = this._eventListeners[k] || [], this._eventListeners[k].push({
      context: s || this,
      eventHandler: m
    }));
  };
  ...
  W.prototype.removeEventListener = function (k, m) {
    if (k && m && this._eventListeners[k]) for (var s = this._eventListeners[k], u = 0; u < s.length; u++) {
  ...
  ia.prototype.render = function (k) {
    if (0 !== this.fontSize) {
      ...
      for (s = 0; s < this._wrappedText.lines.length; s++) {
        E = this._wrappedText.lines[s], "right" === this.horizontalAlign ? u = this.width - E.width - this.rightPadding : "left" === this.horizontalAlign ? u = this.leftPadding : "center" === this.horizontalAlign && (u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding), this.ctx.fillText(E.text, u, y), y += E.height;
      }
  ...
  Ra.prototype.get = function (k, m) {
    var u = null;
    0 < this.pool.length ? (u = this.pool.pop(), Ja(u, k, m)) : u = ra(k, m);
    return u;
  };
  ...
  ma(Ga, W);
  var Ma = {
    addTheme: function addTheme(k, m) {
      Za[k] = m;
    },
    addColorSet: function addColorSet(k, m) {
      xa[k] = m;
    },
    addCultureInfo: function addCultureInfo(k, m) {
      Ha[k] = m;
    },
    formatNumber: function formatNumber(k, m, u) {
      u = u || "en";
      if (Ha[u]) return ea(k, m || "#,##0.##", new Ga(u));
      throw "Unknown Culture Name";
    },
    formatDate: function formatDate(k, m, u) {
      u = u || "en";
      if (Ha[u]) return ya(k, m || "DD MMM YYYY", new Ga(u));
      throw "Unknown Culture Name";
    }
  };
  "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports = Ma : "function" === typeof define && define.amd ? define([], function () {
    return Ma;
  }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Ma);
  ...
  y = Ma.Chart = function () {
    ...
    function m(a, d, c) {
      d = d || {};
      s(c) ? (this.predefinedThemes = Za, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
    ...
    function w(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++) {
        if (0 == e) c.push(a[0]);else {
          ...
          var B = (a[p].x - a[f].x) / b;
          b = (a[p].y - a[f].y) / b;
          c[c.length] = a[l].x > a[f].x && 0 < B || a[l].x < a[f].x && 0 > B ? {
            x: a[l].x + B / 3,
            y: a[l].y + b / 3
          } : {
            x: a[l].x,
    ...
    function y(a, d, c, b, e, f, p, l, B, h) {
      ...
      a.beginPath();
      B && 0 < l.thickness ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - r), a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - r)) : 0 < l.thickness && (a.moveTo(Math.round((d + b) / 2) - r, c + p.thickness / 2), a.lineTo(Math.round((d + b) / 2) - r, e - p.thickness / 2));
      a.stroke();
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        if (!this._zoomButton) {
          ...
          V(this._zoomButton, "click", function () {
            a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, ta(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, ta(a, a._zoomButton, "pan"));
            a.render();
          }, this.allDOMEventHandlers);
          V(this._zoomButton, "mouseover", function () {
            d ? d = !1 : (na(a, a._zoomButton, {
        ...
        this._resetButton || (d = !1, sa(this._resetButton = document.createElement("button")), ta(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor, this._toolBar.appendChild(this._resetButton), V(this._resetButton, "touchstart", function (a) {
          d = !0;
          ...
          a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, ta(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1);
    ...
    m.prototype.setLayout = function () {
      ...
      for (d = 0; d < this._axes.length; d++) {
        if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
          u ? (this._breaksCanvas = ra(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx);
          break;
        }
      }
    ...
    m.prototype.renderElements = function () {
      ...
      if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200, n.animationDuration, function (a) {
        ...
        for (var e = 0; e < c.length; e++) {
          B = c[e], 1 > a && "undefined" !== typeof B.startTimePercent ? a >= B.startTimePercent && B.animationCallback(B.easingFunction(a - B.startTimePercent, 0, 1, 1 - B.startTimePercent), B) : B.animationCallback(B.easingFunction(a, 0, 1, 1), B);
        }
        ...
        if (n._breaksCanvas) if (u) n.plotArea.ctx.drawImage(n._breaksCanvas, 0, 0, this.width, this.height);else for (h = 0; h < n._axes.length; h++) {
      ...
      this.renderCount++;
      Ea && (n = this, setTimeout(function () {
        var a = document.getElementById("ghostCanvasCopy");
        a && (Ja(a, n.width, n.height), a.getContext("2d").drawImage(n._eventManager.ghostCanvas, 0, 0));
      }, 2E3));
    ...
    m.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = [], l = [], B = Infinity, h = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          for (q = 0; q < r.dataPoints.length; q++) {
            ...
            if (b < m && !g) null !== r.dataPoints[q].y && (k = b);else {
              ...
              if (b > t && !v) v = !0;else if (b > t && v) continue;
        ...
        for (q in p) {
          p.hasOwnProperty(q) && !isNaN(q) && (a = p[q], a < d.min && (d.min = Math.min(a, B)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)), a > d.viewPortMax && (d.viewPortMax = a)));
        }

        for (q in l) {
          l.hasOwnProperty(q) && !isNaN(q) && (a = l[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, h)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))));
        }
      }
    };
        ...
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, l = !1, B = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
          ...
          for (r = 0; r < n.dataPoints.length; r++) {
            ...
            if (0 < r) {
              ...
              s(e) || null === n.dataPoints[r - 1].y || (a.axisY.logarithmic ? 0 < e && (t = e / n.dataPoints[r - 1].y, 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - n.dataPoints[r - 1].y, 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)));
            }
            ...
            if (b < k && !q) null !== e && (v = b);else {
              ...
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e ? c.viewPortMin === b && v < b && (c.viewPortMin = v) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ? p = !0 : 0 > e && (l = !0), B[b] = B[b] ? B[b] + Math.abs(e) : Math.abs(e));
            }
          }
    ...
    m.prototype._processSpecificPlotUnit = function (a) {
      if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
        ...
        for (B = 0; B < l.dataPoints.length; B++) {
          "undefined" !== typeof l.dataPoints[B].isCumulativeSum && !0 === l.dataPoints[B].isCumulativeSum ? (l.dataPointEOs[B].cumulativeSumYStartValue = 0, l.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum, l.dataPoints[B].y = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum) : "undefined" !== typeof l.dataPoints[B].isIntermediateSum && !0 === l.dataPoints[B].isIntermediateSum ? (l.dataPointEOs[B].cumulativeSumYStartValue = r, l.dataPointEOs[B].cumulativeSum = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum, l.dataPoints[B].y = 0 === B ? 0 : b, r = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum, b = 0) : (e = "number" !== typeof l.dataPoints[B].y ? 0 : l.dataPoints[B].y, l.dataPointEOs[B].cumulativeSumYStartValue = 0 === B ? 0 : l.dataPointEOs[B - 1].cumulativeSum, l.dataPointEOs[B].cumulativeSum = 0 === B ? e : l.dataPointEOs[B - 1].cumulativeSum + e, b += e);
        }

        for (B = 0; B < l.dataPoints.length; B++) {
          if ("undefined" === typeof l.dataPoints[B].x && (l.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)), l.dataPoints[B].x.getTime ? (f = !0, b = l.dataPoints[B].x.getTime()) : b = l.dataPoints[B].x, e = l.dataPoints[B].y, b < c.min && (c.min = b), b > c.max && (c.max = b), l.dataPointEOs[B].cumulativeSum < d.min && (d.min = l.dataPointEOs[B].cumulativeSum), l.dataPointEOs[B].cumulativeSum > d.max && (d.max = l.dataPointEOs[B].cumulativeSum), 0 < B && (a.axisX.logarithmic ? (r = b / l.dataPoints[B - 1].x, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - l.dataPoints[B - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), null !== e && null !== l.dataPoints[B - 1].y && (a.axisY.logarithmic ? (e = l.dataPointEOs[B].cumulativeSum / l.dataPointEOs[B - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = l.dataPointEOs[B].cumulativeSum - l.dataPointEOs[B - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || h) {
            if (!h && (h = !0, 0 < B)) {
              B -= 2;
              continue;
            }
    ...
    m.prototype.calculateAutoBreaks = function () {
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, p = f.max, l = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, r = 0, B = 0; B < a.dataSeriesIndexes.length; B++) {
            var k = e.data[a.dataSeriesIndexes[B]];
            if (!(4 > k.dataPoints.length)) for (r = 0; r < k.dataPoints.length; r++) {
              if (b && (q = (p + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[r].x.getTime ? k.dataPoints[r].x.getTime() : k.dataPoints[r].x, q = Math.floor((g - h) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                ...
                if ((g = "waterfall" === a.type ? k.dataPointEOs[r].cumulativeSum : k.dataPoints[r].y) && g.length) for (var u = 0; u < g.length; u++) {
                  q = Math.floor((g[u] - l) / m), g[u] < d[q].min && (d[q].min = g[u]), g[u] > d[q].max && (d[q].max = g[u]);
      ...
      function c(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (!(4 > l.dataPoints.length)) for (h = 0; h < l.dataPoints.length; h++) {
            g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = l.dataPoints[h].x.getTime ? l.dataPoints[h].x.getTime() : l.dataPoints[h].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max = b);
          }
        }
      }
      ...
      if (f) {
        for (p = 0; p < this.plotInfo.plotTypes.length; p++) {
          for (f = this.plotInfo.plotTypes[p], l = 0; l < f.plotUnits.length; l++) {
            b = f.plotUnits[l], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b);
          }
        }
        ...
        for (p = 0; p < this._axes.length; p++) {
          if (this._axes[p].dataInfo._dataRanges) {
            ...
            if (this._axes[p].dataInfo.dataPointYNegativeSums) {
              ...
              for (l in q) {
                q.hasOwnProperty(l) && !isNaN(l) && (r = -1 * q[l], s(r) || (g = Math.floor((r - B) / b), r < n[g].min && (n[g].min = r), r > n[g].max && (n[g].max = r)));
              }
            ...
            for (l = 0; l < h.length - 1; l++) {
              if (n = h[l].max, isFinite(n)) for (; l < h.length - 1;) {
            ...
            if (this._axes[p].scaleBreaks.customBreaks) for (l = 0; l < this._axes[p].scaleBreaks.customBreaks.length; l++) {
              for (b = 0; b < f.length; b++) {
                if (this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue || this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue || f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].startValue && this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].end || f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue && this._axes[p].scaleBreaks.customBreaks[l].endValue <= f[b].end) f.splice(b, 1), b--;
              }
            }
            f.sort(function (a, b) {
            ...
            for (l = 0; l < Math.min(f.length, this._axes[p].scaleBreaks.maxNumberOfAutoBreaks); l++) {
              b = a(f[l].start, f[l].end, this._axes[p].logarithmic ? this._axes[p].dataInfo.max / this._axes[p].dataInfo.min : this._axes[p].dataInfo.max - this._axes[p].dataInfo.min, this._axes[p].logarithmic), this._axes[p].scaleBreaks.autoBreaks.push(new U(this, "autoBreaks", b, l, ++this._eventManager.lastObjectId, this._axes[p].scaleBreaks)), this._axes[p].scaleBreaks._appliedBreaks.push(this._axes[p].scaleBreaks.autoBreaks[this._axes[p].scaleBreaks.autoBreaks.length - 1]);
            }
    ...
    m.prototype.getObjectAtXY = function (a, d, c) {
      var b = null;
      if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex];else if (u) b = Wa(a, d, this._eventManager.ghostCtx);else for (c = 0; c < this.legend.items.length; c++) {
    ...
    m.prototype._mouseEventHandler = function (a) {
      ...
      if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1;else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ea && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e) {
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (var f = 0 <= this.zoomType.indexOf("x"), p = 0 <= this.zoomType.indexOf("y"), l = !1, B = [], h = [], n = [], r = 0; r < this._axes.length; r++) {
      ...
      for (p = 0; p < h.length; p++) {
        ...
        if (q > g) var v = g,
            g = q,
            q = v;
        if (r.scaleBreaks) for (v = 0; !f && v < r.scaleBreaks._appliedBreaks.length; v++) {
          f = r.scaleBreaks._appliedBreaks[v].startValue <= q && r.scaleBreaks._appliedBreaks[v].endValue >= g;
        }
        if (isFinite(r.dataInfo.minDiff)) if (v = r.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && (r.logarithmic && v < Math.pow(r.dataInfo.minDiff, 3) || !r.logarithmic && v < 3 * Math.abs(r.dataInfo.minDiff)) || q < r.minimum || g > r.maximum)) B.push(r), n.push({
          val1: q,
          val2: g
        }), l = !0;else if (!e) {
          l = !1;
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (null !== F && "" !== F) {
          ...
          if ("stackedarea100" === n) {
            ...
            if (h.dataPoint.x < A.viewportMinimum || h.dataPoint.x > A.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < z.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > z.viewportMaximum) continue;
          } else if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
            if (h.dataPoint.x < A.viewportMinimum || h.dataPoint.x > A.viewportMaximum || h.dataPoint.y < z.viewportMinimum || h.dataPoint.y > z.viewportMaximum) continue;
          } else if (0 <= n.indexOf("column") || "waterfall" === n || "error" === n && !h.axisSwapped) {
            if (h.dataPoint.x < A.viewportMinimum || h.dataPoint.x > A.viewportMaximum || h.bounds.y1 > c.y2 || h.bounds.y2 < c.y1) continue;
          } else if (0 <= n.indexOf("bar") || "error" === n) {
            if (h.dataPoint.x < A.viewportMinimum || h.dataPoint.x > A.viewportMaximum || h.bounds.x1 > c.x2 || h.bounds.x2 < c.x1) continue;
          } else if ("candlestick" === n || "ohlc" === n) {
            if (h.dataPoint.x < A.viewportMinimum || h.dataPoint.x > A.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < z.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > z.viewportMaximum) continue;
          } else if (h.dataPoint.x < A.viewportMinimum || h.dataPoint.x > A.viewportMaximum) continue;
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        h = this._indexLabels[a], g = ka("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), h.dataSeries.indexLabelBackgroundColor = s(g) ? u ? "transparent" : null : g;
      }
        ...
        for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < n.length) {
            for (var C = !1, t = 0; t < n.length; t++) {
              if (x = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C))) if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || C || m) && (c.stroke(), u && b.stroke()), C = !0;else {
    ...
    m.prototype.renderStepLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < n.length) {
            for (var C = !1, t = 0; t < n.length; t++) {
              if (x = n[t].getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C))) if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || C || m) && (c.stroke(), u && b.stroke()), C = !0;else {
                var A = s;
                x = a.axisX.convertValueToPixel(x);
                s = a.axisY.convertValueToPixel(n[t].y);
                ...
                m || C ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), r = h.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, A), c.lineTo(x, s), u && (b.lineTo(x, A), b.lineTo(x, s))) : (c.beginPath(), c.moveTo(x, s), u && (b.beginPath(), b.moveTo(x, s))), C = m = !1) : (c.lineTo(x, A), u && b.lineTo(x, A), c.lineTo(x, s), u && b.lineTo(x, s), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), u && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                p = {
                  x: x,
                  y: s
                };
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < n.length) for (x = !1, m = 0; m < n.length; m++) {
            if (t = n[m].getTime ? n[m].x.getTime() : n[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x))) if ("number" !== typeof n[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && 0 < s.length && (h.options.nullDataLineDashType || !n[m - 1].lineDashType) && (s[s.length - 1].newLineDashArray = q, r = h.nullDataLineDashType) : (d(s), s = [])), x = !0;else {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          var q = a.dataSeriesIndexes[n],
              g = this.data[q],
              v = g.dataPoints;
          if (0 < v.length) for (var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0; f < v.length; f++) {
            ...
            for (h = 0; h < t.length; h++) {
              if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                ...
                var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                    C = s + g << 0,
                    A;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) l[b] = t[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (r = a.axisY.convertValueToPixel(l[b]), A = "undefined" !== typeof f[b] ? f[b] : q, f[b] = r);else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) B[b] = t[h].y + (B[b] ? B[b] : 0), A = a.axisY.convertValueToPixel(B[b]), r = "undefined" !== typeof p[b] ? p[b] : q, p[b] = A;else if (r = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) {
                  var z = "undefined" !== typeof f[b] ? f[b] : 0;
                  r -= z;
                  A = q - z;
                  f[b] = z + (A - r);
                } else z = p[b] ? p[b] : 0, A = r + z, r = q + z, p[b] = z + (A - r);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var v = 0; v < a.dataSeriesIndexes.length; v++) {
          var k = a.dataSeriesIndexes[v],
              m = this.data[k],
              t = m.dataPoints;
          if (0 < t.length) for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++) {
            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
              n = a.axisX.convertValueToPixel(b);
              ...
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                ...
                A = f[b] ? f[b] : q;
                f[b] = r;
              } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) B[b] = r + ("undefined" !== typeof B[b] ? B[b] : 0), A = a.axisY.convertValueToPixel(B[b]), r = p[b] ? p[b] : q, p[b] = A;else if (r = a.axisY.convertValueToPixel(r), 0 <= t[h].y) {
                var z = "undefined" !== typeof f[b] ? f[b] : 0;
                r -= z;
                A = q - z;
                a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y1 - r) && (r = e.y1);
                f[b] = z + (A - r);
              } else z = "undefined" !== typeof p[b] ? p[b] : 0, A = r + z, r = q + z, a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.y2 - A) && (A = e.y2), p[b] = z + (A - r);
            ...
            for (h = 0; h < t.length; h++) {
              if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                ...
                var s = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                    C = s + g << 0,
                    A;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) l[b] = t[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (A = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(l[b]));else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) B[b] = t[h].y + (B[b] ? B[b] : 0), n = p[b] ? p[b] : q, p[b] = A = a.axisY.convertValueToPixel(B[b]);else if (n = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) {
                  var z = f[b] ? f[b] : 0;
                  A = q + z;
                  n += z;
                  f[b] = z + (n - A);
                } else z = p[b] ? p[b] : 0, A = n - z, n = q - z, p[b] = z + (n - A);
                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++) {
              if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                ...
                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) B[b] = s + (B[b] ? B[b] : 0), n = p[b] ? p[b] : q, p[b] = s = a.axisY.convertValueToPixel(B[b]);else if (n = a.axisY.convertValueToPixel(s), 0 <= t[h].y) {
                  var z = f[b] ? f[b] : 0;
                  s = q + z;
                  n += z;
                  a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.x2 - n) && (n = e.x2);
                  f[b] = z + (n - s);
                } else z = p[b] ? p[b] : 0, s = n - z, n = q - z, a.dataSeriesIndexes.length - 1 === v && 1 >= Math.abs(e.x1 - s) && (s = e.x1), p[b] = z + (n - s);
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        A && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = F : 0 > a.axisY.viewportMaximum ? C = l.y1 : 0 < a.axisY.viewportMinimum && (C = F), f.lineTo(m, C), f.lineTo(A.x, C), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, u && (p.lineTo(m, C), p.lineTo(A.x, C), p.closePath(), p.fill()), f.beginPath(), f.moveTo(m, t), p.beginPath(), p.moveTo(m, t), A = {
          x: m,
          y: t
        });
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          var k = 0,
              ...
              t,
              s,
              F = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
              C,
              A = null;
          ...
          if (0 < v.length) {
            ...
            for (var ja = !0; k < v.length; k++) {
              if (s = v[k].x.getTime ? v[k].x.getTime() : v[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja))) if ("number" !== typeof v[k].y) g.connectNullData || ja || d || b(), ja = !0;else {
                m = a.axisX.convertValueToPixel(s);
                t = a.axisY.convertValueToPixel(v[k].y);
                d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, A = n, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, t), u && p.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), u && (p.beginPath(), p.moveTo(m, t)), A = {
                  x: m,
                  y: t
                ...
                0 !== v[k].markerSize && (0 < v[k].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(k, m, t, f), B.push(s), Z = P(Z), u && B.push({
                  x: m,
                  y: t,
                  ctx: p,
                  type: s.type,
      ...
      function d() {
        ...
        if (0 < c.length) {
          ...
          for (d = 0; d < c.length - 3; d += 3) {
            b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), u && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y);
          }
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < r.length) {
            ...
            for (v = !1; q < r.length; q++) {
              if (g = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !v))) if ("number" !== typeof r[q].y) 0 < q && !v && (n.connectNullData ? b.setLineDash && 0 < s.length && (n.options.nullDataLineDashType || !r[q - 1].lineDashType) && (s[s.length - 1].newLineDashArray = y, z = n.nullDataLineDashType) : (d(), s = [])), v = !0;else {
                ...
                q < r.length - 1 && (A !== (r[q].lineColor || C) || z !== (r[q].lineDashType || n.lineDashType)) && (A = r[q].lineColor || C, s[s.length - 1].newStrokeStyle = A, b.setLineDash && (r[q].lineDashType ? (z = r[q].lineDashType, s[s.length - 1].newLineDashArray = N(z, n.lineThickness)) : (z = n.lineDashType, s[s.length - 1].newLineDashArray = D)));
          ...
          if (0 < v.length) {
            ...
            for (; k < v.length; k++) {
              if (s = v[k].x.getTime ? v[k].x.getTime() : v[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                var Z = t;
                "number" !== typeof v[k].y ? (g.connectNullData || c || d || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(v[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, A = n, S = g.nullDataLineDashType, f.setLineDash(R)), f.lineTo(m, Z), f.lineTo(m, t), u && (p.lineTo(m, Z), p.lineTo(m, t))) : (f.beginPath(), f.moveTo(m, t), u && (p.beginPath(), p.moveTo(m, t)), A = {
                  x: m,
                  y: t
                }), c = d = !1) : (f.lineTo(m, Z), u && p.lineTo(m, Z), f.lineTo(m, t), u && p.lineTo(m, t), 0 == k % 250 && b()), n = {
                  x: m,
                  y: t
                }, k < v.length - 1 && (y !== (v[k].lineColor || w) || S !== (v[k].lineDashType || g.lineDashType)) && (b(), y = v[k].lineColor || w, f.strokeStyle = y, f.setLineDash && (v[k].lineDashType ? (S = v[k].lineDashType, f.setLineDash(N(S, g.lineThickness))) : (S = g.lineDashType, f.setLineDash(D)))), s = g.dataPointIds[k], this._eventManager.objectMap[s] = {
                  id: s,
                  objectType: "dataPoint",
                  dataSeriesIndex: q,
                  dataPointIndex: k,
                  x1: m,
                  y1: t
                }, 0 !== v[k].markerSize && (0 < v[k].markerSize || 0 < g.markerSize) && (Z = g.getMarkerProperties(k, m, t, f), B.push(Z), s = P(s), u && B.push({
                  x: m,
                  y: t,
                  ctx: p,
                  type: Z.type,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          for (q = 0; q < w.length; q++) {
            A = w[q].x.getTime ? w[q].x.getTime() : w[q].x, z.dataPointIndexes[A] = q, e[A] || (n.push(A), e[A] = !0);
          }
        ...
        for (C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < n.length) {
            ...
            for (var Z = !0, q = 0; q < n.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Z))) if ("number" !== typeof fa.y) z.connectNullData || Z || x || d(), Z = !0;else {
                ...
                q < w.length - 1 && (S !== (w[q].lineColor || y) || F !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, v), h.push({
                  x: g,
                  y: m - la
                ...
                0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (la = z.getMarkerProperties(z.dataPointIndexes[f], g, v, b), p.push(la), f = P(E), u && p.push({
                  x: g,
                  y: v,
                  ctx: s,
                  type: la.type,
        ...
        X.drawMarkers(p);
        u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(l.x1, l.y1, l.width, l.height), s.restore());
        b.restore();
        return {
          source: c,
          dest: this.plotArea.ctx,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], w = 0; w < a.dataSeriesIndexes.length; w++) {
          ...
          for (q = 0; q < y.length; q++) {
            A = y[q].x.getTime ? y[q].x.getTime() : y[q].x, z.dataPointIndexes[A] = q, e[A] || (n.push(A), e[A] = !0);
          }
        ...
        for (w = 0; w < a.dataSeriesIndexes.length; w++) {
          ...
          if (0 < n.length) {
            ...
            for (var Z = !0, q = 0; q < n.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Z))) if ("number" !== typeof fa.y) z.connectNullData || Z || s || d(), Z = !0;else {
                var la;
                ...
                k[f] = x - v;
                s || Z ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || t === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (s = h.pop(), t = h[h.length - 1], d(), b.moveTo(m.x, m.y), h.push(t), h.push(s), t = z.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, v), u && F.lineTo(g, v)) : (b.beginPath(), b.moveTo(g, v), u && (F.beginPath(), F.moveTo(g, v))), Z = s = !1) : (b.lineTo(g, v), u && F.lineTo(g, v), 0 == q % 250 && (d(), b.moveTo(g, v), u && F.moveTo(g, v), h.push({
                  x: g,
                  y: x - ba
                })));
                m = {
                ...
                0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, g, v, b), l.push(ba), f = P(G), u && l.push({
                  x: g,
                  y: v,
                  ctx: F,
                  type: ba.type,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++) {
          for (var n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, g = 0, e = 0; e < q.length; e++) {
            f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (g = q[e].z, g > l && (l = g), g < k && (k = g));
          }
        }

        for (var v = 25 * Math.PI, m = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, v), h = 0; h < a.dataSeriesIndexes.length; h++) {
          if (n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          var w = a.dataSeriesIndexes[m],
              t = this.data[w],
              x = t.dataPoints;
          if (0 < x.length) for (var F = 5 < v && t.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++) {
            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3]) {
              ...
              "candlestick" === t.type ? (c.moveTo(k - y, n), c.lineTo(k - y, Math.min(h, q)), c.stroke(), c.moveTo(k - y, Math.max(h, q)), c.lineTo(k - y, r), c.stroke(), ca(c, C, Math.min(h, q), A, Math.max(h, q), x[l].y[0] <= x[l].y[3] ? t.risingColor : f, z, e, F, F, !1, !1, t.fillOpacity), u && (e = P(D), b.strokeStyle = e, b.moveTo(k - y, n), b.lineTo(k - y, Math.min(h, q)), b.stroke(), b.moveTo(k - y, Math.max(h, q)), b.lineTo(k - y, r), b.stroke(), ca(b, C, Math.min(h, q), A, Math.max(h, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (c.moveTo(k - y, n), c.lineTo(k - y, r), c.stroke(), c.beginPath(), c.moveTo(k, h), c.lineTo(C, h), c.stroke(), c.beginPath(), c.moveTo(k, q), c.lineTo(A, q), c.stroke(), u && (e = P(D), b.strokeStyle = e, b.moveTo(k - y, n), b.lineTo(k - y, r), b.stroke(), b.beginPath(), b.moveTo(k, h), b.lineTo(C, h), b.stroke(), b.beginPath(), b.moveTo(k, q), b.lineTo(A, q), b.stroke()));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = !1, m = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
          var t = a.dataSeriesIndexes[w],
              x = this.data[t],
              F = x.dataPoints;
          if (0 < F.length) for (var C = 5 < v && x.bevelEnabled ? !0 : !1, p = 0; p < F.length; p++) {
            if (F[p].getTime ? g = F[p].x.getTime() : g = F[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(F[p].y) && F[p].y.length && "number" === typeof F[p].y[0] && "number" === typeof F[p].y[1] && "number" === typeof F[p].y[2] && "number" === typeof F[p].y[3] && "number" === typeof F[p].y[4] && 5 === F[p].y.length) {
              ...
              (F[p].indexLabel || x.indexLabel || F[p].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                chartType: x.type,
                dataPoint: F[p],
                dataSeries: x,
                point: {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          var r = a.dataSeriesIndexes[n],
              q = this.data[r],
              g = q.dataPoints;
          if (0 < g.length) for (var v = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) {
            if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
              ...
              var m = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + n) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + n) * h << 0,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var F = a.dataSeriesIndexes[x],
              ...
              D = 0;
          if (z) for (e = C._linkedSeries.id, t = 0; t < e; t++) {
          ...
          f && (l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? w : 1))) << 0 : 0.03 * this.width);
          ...
          t < e && (t = e);
          t > l && (t = l);
          if (0 < A.length) for (var E = C._colorSet, l = 0; l < A.length; l++) {
            ...
            var R = {
              ...
              dashType: A[l].stemDashType ? A[l].stemDashType : C.stemDashType
            };
            ...
            if (!(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax) && !s(A[l].y) && A[l].y.length && "number" === typeof A[l].y[0] && "number" === typeof A[l].y[1]) {
              ...
              b ? r = ja : g = ja;
              b ? (q = a.axisX.reversed ? h + (z ? w : 1) * t / 2 - (z ? D - 1 : 0) * t << 0 : h - (z ? w : 1) * t / 2 + (z ? D - 1 : 0) * t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (n = a.axisX.reversed ? k + (z ? w : 1) * t / 2 - (z ? D - 1 : 0) * t << 0 : k - (z ? w : 1) * t / 2 + (z ? D - 1 : 0) * t << 0, r = a.axisX.reversed ? n - t << 0 : n + t << 0);
              !b && q > g && (ja = q, q = g, g = ja);
              b && n > r && (ja = n, n = r, r = ja);
              ja = C.dataPointIds[l];
              ...
              if (A[l].indexLabel || C.indexLabel || A[l].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({
                chartType: "error",
                dataPoint: A[l],
                dataSeries: C,
                indexKeyword: 0,
                ...
                indexKeyword: 1,
                point: {
                  x: b ? A[l].y[1] >= A[l].y[0] ? r : n : n + (r - n) / 2,
          ...
          if (0 < v.length) {
            ...
            for (f = 0; f < v.length; f++) {
              if (v[f].getTime ? h = v[f].x.getTime() : h = v[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(v[f].y) && v[f].y.length && "number" === typeof v[f].y[0] && "number" === typeof v[f].y[1]) {
                ...
                if (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({
                  chartType: "rangeBar",
                  dataPoint: v[f],
                  dataSeries: g,
                  indexKeyword: 0,
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < r.length) {
            ...
            for (var S = !0; g < r.length; g++) {
              if (t = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S))) if (null !== r[g].y && r[g].y.length && "number" === typeof r[g].y[0] && "number" === typeof r[g].y[1]) {
                v = a.axisX.convertValueToPixel(t);
                m = a.axisY.convertValueToPixel(r[g].y[0]);
                s = a.axisY.convertValueToPixel(r[g].y[1]);
                q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D, z = n.nullDataLineDashType, b.setLineDash(y)), b.lineTo(v, m), u && e.lineTo(v, m), k.push({
                  x: v,
                  y: s
                })) : (b.beginPath(), b.moveTo(v, m), x = {
                  x: v,
                  y: m
                }, k = [], k.push({
                  x: v,
                  y: s
                }), u && (e.beginPath(), e.moveTo(v, m))), S = q = !1) : (b.lineTo(v, m), k.push({
                  x: v,
                  y: s
                }), u && e.lineTo(v, m), 0 == g % 250 && d());
                t = n.dataPointIds[g];
                this._eventManager.objectMap[t] = {
                  id: t,
                  objectType: "dataPoint",
                ...
                g < r.length - 1 && (A !== (r[g].lineColor || C) || z !== (r[g].lineDashType || n.lineDashType)) && (d(), A = r[g].lineColor || C, k[k.length - 1].newStrokeStyle = A, b.strokeStyle = A, b.setLineDash && (r[g].lineDashType ? (z = r[g].lineDashType, k[k.length - 1].newLineDashArray = N(z, n.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (z = n.lineDashType, k[k.length - 1].newLineDashArray = D, b.setLineDash(D))));
      ...
      function d(a, c) {
        ...
        if (0 < d.length) {
          ...
          for (f = 0; f < d.length - 3; f += 3) {
            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y), u && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
          }
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < n.length) {
            ...
            for (g = !1; r < n.length; r++) {
              if (q = n[r].x.getTime ? n[r].x.getTime() : n[r].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g))) if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" === typeof n[r].y[1]) {
                ...
                if (n[r].indexLabel || h.indexLabel || n[r].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({
    ...
    m.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < w.length) for (var F = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, A = null, z = null, p = 0; p < w.length; p++) {
            if (w[p].getTime ? n = w[p].x.getTime() : n = w[p].x, "number" !== typeof w[p].y) {
              if (0 < p && !C && s.connectNullData) var y = s.options.nullDataLineDashType || !w[p - 1].lineDashType ? s.nullDataLineDashType : w[p - 1].lineDashType;
              C = !0;
            } else {
              ...
              var S = w[p].color ? w[p].color : 0 < w[p].y ? s.risingColor : s.fallingColor;
              ...
              0 < p && A && (!C || s.connectNullData) && (C && c.setLineDash && c.setLineDash(N(y, t)), c.beginPath(), c.moveTo(A, z - x), c.lineTo(S, R - x), 0 < t && c.stroke(), u && (b.beginPath(), b.moveTo(A, z - x), b.lineTo(S, R - x), 0 < t && b.stroke()));
              C = !1;
              A = D;
              z = 0 < w[p].y ? k : h;
    ...
    var Y = function Y(a, d, c, b, e, f, p, l, k) {
      if (!(0 > c)) {
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (h && n) {
          ...
          for (e = 0; e < n.length; e++) {
            l = g[(c + e) % n.length], 1 < a && l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t && (f <= a / 2 && !r ? (l.hemisphere = "right", f++) : (l.hemisphere = "left", r = !0));
          }

          r = !1;

          for (e = 0; e < n.length; e++) {
            l = g[(d + e) % n.length], 1 < b && l.midAngle > 3 * Math.PI / 2 - t && l.midAngle < 3 * Math.PI / 2 + t && (p <= b / 2 && !r ? (l.hemisphere = "left", p++) : (l.hemisphere = "right", r = !0));
          }
        }
      }
      ...
      function c(a) {
        ...
        for (b = 0; b < n.length; b++) {
          ...
          if (d > c) {
            ...
            if (n[b].exploded) {
              if (1E-9 < Math.abs(g[b].center.x - (F.x + e)) || 1E-9 < Math.abs(g[b].center.y - (F.y + f))) g[b].center.x = F.x + e * a, g[b].center.y = F.y + f * a, l = !0;
              ...
              if (null !== A) {
                ...
                if (0 > y) {
                  for (var C = s = 0, J = 0; J < n.length; J++) {
                    J !== a && g[J].hemisphere === p.hemisphere && (g[J].indexLabelTextBlock.y < p.indexLabelTextBlock.y ? s++ : C++);
                  }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var A = 0; A < n.length; A++) {
          y += Math.abs(n[A].y), !a && "undefined" !== typeof n[A].indexLabel && null !== n[A].indexLabel && 0 < n[A].indexLabel.toString().length && (a = !0), !a && "undefined" !== typeof n[A].label && null !== n[A].label && 0 < n[A].label.toString().length && (a = !0);
        }

        if (0 !== y) {
          a = a || "undefined" !== typeof h.indexLabel && null !== h.indexLabel && 0 < h.indexLabel.toString().length;
          var z = "inside" !== h.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2;
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        for (var p = d[0] = 0, l = 0, k, n, b = b - a, p = !1, h = 0; h < x.length; h++) {
          a = Math.abs(x[h].y) * f / g, p ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (n = aa * aa * b * b - 4 * Math.abs(aa) * a, 0 > n ? (n = c, p = (b + n) * (e - l) / 2, a -= p, k = e - l, l += e - l, k += 0 == n ? 0 : a / n, l += a / n, p = !0) : (k = (Math.abs(aa) * b - Math.sqrt(n)) / 2, n = b - 2 * k / Math.abs(aa), l += k, l > e && (l -= k, n = c, p = (b + n) * (e - l) / 2, a -= p, k = e - l, l += e - l, k += a / n, l += a / n, p = !0), b = n)), d.push(k);
        }
      ...
      function b() {
        if (t && x) {
          for (var a, b, c, d, e, f, h, l, p, k, n, q, r, m, v = [], B = [], w = {
            percent: null,
            total: null
          }, A = null, z = 0; z < x.length; z++) {
            m = O[z], m = "undefined" !== typeof m.x5 ? (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2, m = g(m).x2 + 1, v[z] = M - m - V;
          }
          ...
          for (var z = 0, F = x.length - 1; z < x.length || 0 <= F; z++, F--) {
            ...
            "inside" === t.indexLabelPlacement && (v[z] = z !== ca ? t.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4 : O[z].x3 - O[z].x6, 20 > v[z] && (v[z] = z !== ca ? t.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1 : O[z].x2 - O[z].x1, v[z] /= 2));
            ...
            b = b.indexLabelFormatter ? b.indexLabelFormatter(A) : b.indexLabel ? y.replaceKeywordsWithValue(b.indexLabel, b, t, z) : t.indexLabelFormatter ? t.indexLabelFormatter(A) : t.indexLabel ? y.replaceKeywordsWithValue(t.indexLabel, b, t, z) : b.label ? b.label : "";
            0 >= k && (k = 0);
      ...
      function e() {
        ...
        if (e) for (l = H.length - 1; 0 <= l; l--) {
          a = O[l], H[l].textBlock.maxWidth = f[f.length - (l + 1)], H[l].textBlock.measureText(), H[l].textBlock.x = M - h, c = H[l].textBlock.height < H[l].textBlock.maxHeight ? H[l].textBlock.height : H[l].textBlock.maxHeight, e = H[l].textBlock.width < H[l].textBlock.maxWidth ? H[l].textBlock.width : H[l].textBlock.maxWidth, H[l].height = c, H[l].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, H[l].textBlock.y = c - H[l].height / 2, t.reversed ? (H[l].textBlock.y + H[l].height > T + C && (H[l].textBlock.y = T + C - H[l].height), H[l].textBlock.y < qa - C && (H[l].textBlock.y = qa - C)) : (H[l].textBlock.y < T - C && (H[l].textBlock.y = T - C), H[l].textBlock.y + H[l].height > qa + C && (H[l].textBlock.y = qa + C - H[l].height));
        }
      }
      ...
      function f() {
        ...
        if ("inside" !== t.indexLabelPlacement) for (var e = 0; e < O.length; e++) {
          0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = t.reversed ? "undefined" !== typeof a.x5 ? c > va ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < va ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + V, H[e].textBlock.y = c - H[e].height / 2, t.reversed ? (H[e].textBlock.y + H[e].height > T + C && (H[e].textBlock.y = T + C - H[e].height), H[e].textBlock.y < qa - C && (H[e].textBlock.y = qa - C)) : (H[e].textBlock.y < T - C && (H[e].textBlock.y = T - C), H[e].textBlock.y + H[e].height > qa + C && (H[e].textBlock.y = qa + C - H[e].height)));
        } else for (e = 0; e < O.length; e++) {
          0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0);
        }
      }
        ...
        function b() {
          ...
          for (var l, p = 1; p < h; p++) {
            ...
            for (var n = H.length - 1; 0 <= n; n--) {
              !H[n].isDirty && H[n].textBlock.y < e && H[n].textBlock.y + H[n].height > e && (l = q(n), !(l >= H.length - 1) && H[n].textBlock.y + H[n].height + da > H[l].textBlock.y && (H[n].textBlock.y = H[n].textBlock.y + H[n].height - e > e - H[n].textBlock.y ? e + 1 : e - H[n].height - 1));
            }
          }
      ...
      function l(a, b) {
        return (b < O.length ? H[b].textBlock.y : t.reversed ? T + C : qa + C) - (0 > a ? t.reversed ? qa - C : T - C : H[a].textBlock.y + H[a].height + da);
      }
        ...
        var s = {
          ...
          changeSection: function changeSection(a) {
            for (var b, c, d = 0; d < O.length; d++) {
              b = g[d], c = O[d], b *= a, "undefined" === typeof r[d] && (r[d] = 0), 0 > r && (r *= -1), c.y1 += b - r[d], c.y2 += b - r[d], c.y3 += b - r[d], c.y4 += b - r[d], c.y5 && (c.y5 += b - r[d], c.y6 += b - r[d]), r[d] = b;
            }
          }
        };
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== x.length) {
          ...
          if (-1 !== R) {
            if (t.reversed) for (E.push(U), G = R.length - 1; 0 < G; G--) {
              U += R[G], E.push(U);
            } else for (G = 0; G < R.length; G++) {
              U += R[G], E.push(U);
            }
            if (t.reversed) for (G = 0; G < R.length; G++) {
              E[G] < va ? (a.push(K), A.push(X), ca = G) : (a.push((E[G] - T + aa * W) / aa), A.push((E[G] - T + ea * $) / ea));
            } else for (G = 0; G < R.length; G++) {
              E[G] < va ? (a.push((E[G] - T + aa * W) / aa), A.push((E[G] - T + ea * $) / ea), ca = G) : (a.push(K), A.push(X));
            }
            ...
            for (G = 0; G < x.length; G++) {
              x[G].exploded && (R = !0, t.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
            }
            ...
            if (I && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) {
              ...
              for (G = 0; G < x.length; G++) {
                H[G].isDirty || (a = H[G].textBlock.x + H[G].width, a = (M - a) / 2, 0 == G && (z = a), z > a && (z = a));
              }

              for (G = 0; G < O.length; G++) {
                O[G].x1 += z, O[G].x2 += z, O[G].x3 += z, O[G].x4 += z, O[G].x5 && (O[G].x5 += z, O[G].x6 += z), H[G].textBlock.x += z;
              }
            }
    ...
    E.prototype.setLayout = function () {
      ...
      for (var n = 0; n < this.dataSeries.length; n++) {
        ...
        if (r.dataPoints && r.dataPoints.length) if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
          ...
          var y = r.dataPoints[x],
              ...
              g = y.legendText ? y.legendText : r.legendText ? r.legendText : this.itemTextFormatter ? this.itemTextFormatter({
            chart: this.chart,
            legend: this.options,
            dataSeries: r,
            dataPoint: y
          }) : y.name ? y.name : "DataPoint: " + (x + 1),
              m = y.legendMarkerColor ? y.legendMarkerColor : r.legendMarkerColor ? r.legendMarkerColor : y.color ? y.color : r.color ? r.color : r._colorSet[x % r._colorSet.length],
      ...
      for (n = 0; n < this.items.length; n++) {
        q = k[n], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = {
          id: q.id,
    ...
    I.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      if ("none" !== this.chart.plotInfo.axisPlacement) if (r = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
        ...
        y: d
          ...
          r = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(r / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, r = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (r - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
    ...
    D.prototype.createLabels = function () {
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
      ...
      } else for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Ta(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c < e; Ta(c, b, this.intervalType)) {
        ...
        a || (a = this.labelFormatter ? this.labelFormatter({
          ...
          value: new Date(n),
          label: this.labels[n] ? this.labels[n] : null
        }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : ya(n, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
          x: 0,
          y: 0,
          maxWidth: f,
          backgroundColor: this.labelBackgroundColor,
      ...
      if (this.labelAutoFit || this.options.labelAutoFit) if (s(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) {
        if (f = 0.9 * l >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
            ...
            if (!this._labels[c].breaksLabelType) {
              ...
              if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) {
                if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), n = (h - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !s(this.options.labelWrap)) this.labelWrap ? s(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), n), this.sessionVariables.labelWrap = this.labelWrap, d && m.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : s(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelMaxWidth = f, d && m.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelWrap = this.labelWrap);else {
                  if (s(this.options.labelWrap)) if (!s(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = p);else if (!s(d)) if (b = m.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > r && (r = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 2.2 * f && b < 2.8 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n, this.sessionVariables.labelFontSize = g) : b >= 2.8 * f && b < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, q), this.sessionVariables.labelWrap = !0, s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = n, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelAngle = this.labelAngle));else if (w === c && (0 === w && q + this._labels[w + 1].textBlock.measureText().width - 2 * f > r || w === this._labels.length - 1 && q + this._labels[w - 1].textBlock.measureText().width - 2 * f > r || 0 < w && w < this._labels.length - 1 && q + this._labels[w + 1].textBlock.measureText().width - 2 * f > r && q + this._labels[w - 1].textBlock.measureText().width - 2 * f > r)) r = 0 === w ? q + this._labels[w + 1].textBlock.measureText().width - 2 * f : q + this._labels[w - 1].textBlock.measureText().width - 2 * f, this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n;else if (0 === r) for (this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) {
      ...
      } else if ("left" === this._position || "right" === this._position) if (f = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, p = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
        this.sessionVariables.labelFontSize = this.labelFontSize;
        this.sessionVariables.labelMaxWidth = f;
        this.sessionVariables.labelMaxHeight = p;
        ...
        for (c = 0; c < this._labels.length; c++) {
          if (!this._labels[c].breaksLabelType) {
            ...
            Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
            Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
            s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? s(this.options.labelWrap) ? s(this.options.labelWrap) && (s(this.options.labelMaxWidth) ? s(d) || (l = m.height + d.height >> 0, l - 2 * p > q && (q = l - 2 * p, l >= 2 * p && l < 2.4 * p ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : l >= 2.4 * p && l < 2.8 * p ? (this.sessionVariables.labelMaxHeight = b, this.sessionVariables.labelFontSize = this.labelFontSize, this.sessionVariables.labelWrap = !0) : l >= 2.8 * p && l < 3.2 * p ? (this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelWrap = !0, s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l >= 3.2 * p && l < 3.6 * p ? (this.sessionVariables.labelMaxHeight = b, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelFontSize = this.labelFontSize) : l > 3.6 * p && l < 10 * p ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l > 10 * p && l < 50 * p && (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : f, this.sessionVariables.labelMaxHeight = p) : (this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? f : Math.min((b - p * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), p), s(this.options.labelWrap)) ? s(this.options.labelWrap) && (this.labelWrap && !s(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth > this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : f, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : b, s(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : b, this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = f) : (this.sessionVariables.labelMaxHeight = p, s(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth, this.sessionVariables.labelWrap = this.labelWrap);
          }
        }
      ...
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        if ("outside" === f.labelPlacement) {
          ...
          if ("left" === this._position || "right" === this._position) y = s(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
    ...
    D.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++) {
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length) for (var m = q[g].scaleBreaks._appliedBreaks, u = 0; u < m.length && !(m[u].startValue > q[g].viewportMaximum); u++) {
          m[u].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = u), m[u].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = u));
        }
      }

      for (var w = u = 0, t = 0, x = 0, y = 0, C = 0, A = 0, z, D, E = l = 0, I, J, L, m = I = J = L = !1, g = 0; g < q.length; g++) {
      ...
      if ("normal" === e) {
        for (var x = [], y = [], C = [], A = [], M = [], N = [], P = [], Q = []; 4 > u;) {
          var G = 0,
              ...
              O = 0,
              aa = 0;
          if (c && 0 < c.length) for (C = [], g = O = 0; g < c.length; g++) {
            C.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += C[g], K += c[g] && !n.isNavigator ? c[g].margin : 0;
          } else C.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          P.push(C);
          if (b && 0 < b.length) for (A = [], g = aa = 0; g < b.length; g++) {
            A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), aa += A[g], $ += b[g] ? b[g].margin : 0;
          ...
          if (a && 0 < a.length) for (x = [], g = U = 0; g < a.length; g++) {
            a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(k - p), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ? a[g].titleMaxWidth : a[g].lineCoordinates.width), x.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), U += x[g], e += a[g] && !n.isNavigator ? a[g].margin : 0;
          } else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
          M.push(x);
          if (d && 0 < d.length) for (y = [], g = X = 0; g < d.length; g++) {
            d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(k - p), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), y.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), X += y[g], Y += d[g] && !n.isNavigator ? d[g].margin : 0;
          } else y.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
          N.push(y);
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
            a[g] && (a[g].lineCoordinates.x1 = p, k = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $), a[g]._labels && 1 < a[g]._labels.length && (l = h = 0, h = a[g]._labels[1], l = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), t = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle))), !a[g] || !a[g].labelAutoFit || s(z) || s(D) || n.isNavigator || n.stockChart || (l = 0, 0 < a[g].labelAngle ? D + t > k && (l += 0 < a[g].labelAngle ? D + t - k - aa : 0) : 0 > a[g].labelAngle ? z - w < p && z - w < a[g].viewportMinimum && (E = p - (K + a[g].tickLength + C + z - w + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (D + t > k && (l = D + t / 2 - k - aa), z - w < p && z - w < a[g].viewportMinimum && (E = p - K - a[g].tickLength - C - z + w / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < l ? k -= l : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E ? p += E : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (p += E), 0 < l && (k -= l))), n.panEnabled ? U = s(n.sessionVariables.axisX.height) ? n.sessionVariables.axisX.height = U : n.sessionVariables.axisX.height : n.sessionVariables.axisX.height = U, l = Math.round(f.y2 - U - e + G), h = Math.round(f.y2), a[g].lineCoordinates.x2 = k, a[g].lineCoordinates.width = k - p, a[g].lineCoordinates.y1 = l, a[g].lineCoordinates.y2 = l + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + x[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - ("inside" === a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
              x1: p,
              y1: l,
              x2: k,
              y2: h - (U + e - x[g] - G),
          ...
          if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
            d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K), d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $), d[g].lineCoordinates.width = Math.abs(k - p), d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1], l = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), t = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle))), n.panEnabled ? X = s(n.sessionVariables.axisX2.height) ? n.sessionVariables.axisX2.height = X : n.sessionVariables.axisX2.height : n.sessionVariables.axisX2.height = X, l = Math.round(f.y1), h = Math.round(f.y2 + d[g].margin), d[g].lineCoordinates.y1 = l + X + Y - V, d[g].lineCoordinates.y2 = l, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - y[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)), d[g].bounds = {
              x1: p,
              y1: l + (X + Y - y[g] - V),
              x2: k,
              y2: h,
          ...
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) {
            K = n.isNavigator ? 0 : 10, c[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : r, l = Math.round(f.y1 + X + Y < Math.max(K, r) ? Math.max(K, r) : f.y1 + X + Y), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : r, h = Math.round(f.y2 - U - e - K), c[g].lineCoordinates = {
              x1: p - T,
              y1: l,
              x2: k - T,
              y2: h,
          ...
          if (b && 0 < b.length) for (g = 0; g < b.length; g++) {
            b[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(p), K = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(f.y1 + X + Y < Math.max(K, r) ? Math.max(K, r) : f.y1 + X + Y), K = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, h = Math.round(f.y2 - (U + e + K)), b[g].lineCoordinates = {
              x1: p + W,
              y1: l,
              x2: p + W,
              y2: h,
        ...
        for (N = []; 4 > u;) {
          ...
          if (d && 0 < d.length) for (w = [], g = U = 0; g < d.length; g++) {
            w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), U += w[g], Y += d[g] ? d[g].margin : 0;
          } else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
          N.push(w);
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) {
            c[g].lineCoordinates = {}, p = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > n.width - 10 ? n.width - 10 : f.x2 - U - Y), c[g].labelAutoFit && !s(x) && (0 < !a.length && (p = 0 > c[g].labelAngle ? Math.max(p, x) : 0 === c[g].labelAngle ? Math.max(p, x / 2) : p), 0 < !d.length && (k = 0 < c[g].labelAngle ? k - y / 2 : 0 === c[g].labelAngle ? k - y / 2 : k)), c[g].lineCoordinates.x1 = p, c[g].lineCoordinates.x2 = k, c[g].lineCoordinates.width = Math.abs(k - p), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
          }
          if (b && 0 < b.length) for (g = 0; g < b.length; g++) {
            b[g].lineCoordinates = {}, p = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - Y), b[g] && b[g].labelAutoFit && !s(C) && (0 < !a.length && (p = 0 < b[g].labelAngle ? Math.max(p, C) : 0 === b[g].labelAngle ? Math.max(p, C / 2) : p), 0 < !d.length && (k -= A / 2)), b[g].lineCoordinates.x1 = p, b[g].lineCoordinates.x2 = k, b[g].lineCoordinates.width = Math.abs(k - p), b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
          }
          if (c && 0 < c.length) for (r = [], g = T = 0; g < c.length; g++) {
            r.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), T += r[g] + c[g].margin, K += c[g].margin;
          } else r.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          D.push(r);
          if (b && 0 < b.length) for (z = [], g = V = 0; g < b.length; g++) {
            z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), V += z[g], $ += b[g].margin;
          } else z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
          t.push(z);
          if (c && 0 < c.length) for (g = 0; g < c.length; g++) {
            0 < c[g]._labels.length && (h = c[g]._labels[0], l = c[g]._labels[c[g]._labels.length - 1], x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), y = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle)));
          }
          if (b && 0 < b.length) for (g = 0; g < b.length; g++) {
            b[g] && 0 < b[g]._labels.length && (h = b[g]._labels[0], l = b[g]._labels[b[g]._labels.length - 1], C = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), A = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle)));
          }
          ...
          if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--) {
            l = Math.round(f.y2), h = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = l - (r[g] + c[g].margin + X), c[g].lineCoordinates.y2 = l - (r[g] + c[g].margin + X), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + r[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {
              x1: p,
              ...
              width: k - p,
              height: r[g]
            }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width), X += r[g] + c[g].margin;
          }
          if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) {
            b[g] && (l = Math.round(f.y1), h = Math.round(f.y1 + (z[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - z[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
              x1: p,
              y1: l + (b[g].margin + G),
              x2: k,
              y2: h,
          ...
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
            ...
            if (c && 0 < c.length) for (K = 0; K < c.length; K++) {
              c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, p = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - W : p);
            }
            if (b && 0 < b.length) for (K = 0; K < b.length; K++) {
              b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x1, p = k - W);
            }
            a[g].lineCoordinates = {
              x1: k - P,
              y1: l,
          ...
          if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
            ...
            h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2 - T) : f.y2 > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2;
            if (c && 0 < c.length) for (K = 0; K < c.length; K++) {
              c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, p = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : p);
            }
            if (b && 0 < b.length) for (K = 0; K < b.length; K++) {
              b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x2, p = k - U);
            }
            d[g].lineCoordinates = {
              x1: k + Q,
              y1: l,
    ...
    D.render = function (a, d, c, b, e) {
      ...
      e.restore();
      if (a && 0 < a.length) for (l = 0; l < a.length; l++) {
        a[l].renderGrid(), u && (a[l].createMask(), a[l].renderBreaksBackground());
      }
      if (d && 0 < d.length) for (l = 0; l < d.length; l++) {
        d[l].renderGrid(), u && (d[l].createMask(), d[l].renderBreaksBackground());
      }
      if (c && 0 < c.length) for (l = 0; l < c.length; l++) {
        c[l].renderGrid(), u && (c[l].createMask(), c[l].renderBreaksBackground());
      }
      if (b && 0 < b.length) for (l = 0; l < b.length; l++) {
        b[l].renderGrid(), u && (b[l].createMask(), b[l].renderBreaksBackground());
      }
      if (a && 0 < a.length) for (l = 0; l < a.length; l++) {
        a[l].renderAxisLine();
      }
    ...
    D.prototype.calculateBreaksSizeInValues = function () {
      for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !s(this.scaleBreaks.options.spacing), e, f = 0; f < d.length; f++) {
        e = b || !s(d[f].options.spacing), d[f].spacing = Pa(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, d[f].size = 0 > d[f].spacing ? 0 : Math.abs(d[f].spacing / c), this.logarithmic && (d[f].size = Math.pow(this.logarithmBase, d[f].size));
      }
    };
    ...
    D.prototype.renderLabelsTicksAndTitle = function () {
      ...
      if ("undefined" === typeof this.options.interval) {
        if ("bottom" === this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          ...
          for (h = 0; h < this._labels.length; h++) {
            r = this._labels[h], r.position < this.viewportMinimum || (k = r.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += k);
          }
        ...
        if ("left" === this._position || "right" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          ...
          for (h = 0; h < this._labels.length; h++) {
            r = this._labels[h], r.position < this.viewportMinimum || (n = r.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += n);
          }
      ...
      if ("bottom" === this._position) {
        for (h = 0; h < this._labels.length; h++) {
          r = this._labels[h], r.position < this.viewportMinimum || r.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(r.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.x << 0) + 0.5 : q.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, q.y << 0), this.ctx.lineTo(b, q.y + this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === r.textBlock.angle ? (q.x -= r.textBlock.width / 2, q.y = "inside" === this.labelPlacement ? q.y - (("inside" === this.tickPlacement ? this.tickLength : 0) + r.textBlock.height - r.textBlock.fontSize / 2) : q.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + r.textBlock.fontSize / 2 + 5) : (q.x = "inside" === this.labelPlacement ? 0 > this.labelAngle ? q.x : q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : q.x - (0 > this.labelAngle ? r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), q.y = "inside" === this.labelPlacement ? 0 > this.labelAngle ? q.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : q.y - ("inside" === this.tickPlacement ? 0 : this.tickLength) - Math.abs(r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5) : q.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)), r.textBlock.x = q.x, r.textBlock.y = q.y));
        }
        ...
        for (h = 0; h < this._labels.length; h++) {
          r = this._labels[h], r.position < this.viewportMinimum || r.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(r.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (q.x << 0) + 0.5 : q.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, q.y << 0), this.ctx.lineTo(b, q.y - this.tickLength << 0), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === r.textBlock.angle ? (q.x -= r.textBlock.width / 2, q.y = "inside" === this.labelPlacement ? q.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + r.textBlock.height - r.textBlock.fontSize / 2)) : (q.x = "inside" === this.labelPlacement ? 0 < this.labelAngle ? q.x : q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : q.x + (r.textBlock.height - this.labelFontSize) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), q.y = "inside" === this.labelPlacement ? 0 < this.labelAngle ? q.y + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + ((r.textBlock.height - r.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))), r.textBlock.x = q.x, r.textBlock.y = q.y));
        }
      ...
      if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationEnd", function () {
        for (h = 0; h < a._labels.length; h++) {
          r = a._labels[h], r.position < a.viewportMinimum || r.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit || (a.ctx.save(), a.ctx.beginPath(), r.textBlock.render(!0), a.ctx.restore());
        }
      }, this);else for (h = 0; h < this._labels.length; h++) {
        r = this._labels[h], r.position < this.viewportMinimum || r.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit || r.textBlock.render(!0);
      }
    };
      ...
      if (this.stripLines && 0 < this.stripLines.length && a) {
        ...
        if (!k) {
          ...
          for (b = 0; b < l.length; b++) {
            h = l[b], h.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
              this.ctx.save();
              this.ctx.beginPath();
              this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
              this.ctx.clip();
          ...
          for (b = 0; b < m.length; b++) {
            c = m[b], c.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
        ...
        if (k) for (k = !1, b = 0; b < m.length; b++) {
          c = m[b], c.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
            for (e = 0; e < m.length; e++) {
              c = m[e], "outside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && c.textBlock.render(!0);
            }
    ...
    D.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.beginPath();
          if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;else for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) {
            d.moveTo(e, k), d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + c, k), e = this.scaleBreaks._appliedBreaks[l].endPixel + b;
          }
        ...
        d.beginPath();
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;else for (l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) {
          d.moveTo(k, e), d.lineTo(k, this.scaleBreaks._appliedBreaks[l].startPixel + b), e = this.scaleBreaks._appliedBreaks[l].endPixel + c;
        }
        e && (d.moveTo(k, e), d.lineTo(k, f));
        d.stroke();
      }

      u && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), this.chart._breaksCanvasCtx && this.chart._breaksCanvasCtx.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), d.clearRect(0, 0, this.chart.width, this.chart.height));
      d.restore();
    };
    ...
    D.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();else {
        ...
        if ("axisX" === this.type && c) {
          this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : b / 50 <= a ? (this.interval = 50, this.intervalType = "millisecond") : b / 100 <= a ? (this.interval = 100, this.intervalType = "millisecond") : b / 200 <= a ? (this.interval = 200, this.intervalType = "millisecond") : b / 250 <= a ? (this.interval = 250, this.intervalType = "millisecond") : b / 300 <= a ? (this.interval = 300, this.intervalType = "millisecond") : b / 400 <= a ? (this.interval = 400, this.intervalType = "millisecond") : b / 500 <= a ? (this.interval = 500, this.intervalType = "millisecond") : b / (1 * Q.secondDuration) <= a ? (this.interval = 1, this.intervalType = "second") : b / (2 * Q.secondDuration) <= a ? (this.interval = 2, this.intervalType = "second") : b / (5 * Q.secondDuration) <= a ? (this.interval = 5, this.intervalType = "second") : b / (10 * Q.secondDuration) <= a ? (this.interval = 10, this.intervalType = "second") : b / (15 * Q.secondDuration) <= a ? (this.interval = 15, this.intervalType = "second") : b / (20 * Q.secondDuration) <= a ? (this.interval = 20, this.intervalType = "second") : b / (30 * Q.secondDuration) <= a ? (this.interval = 30, this.intervalType = "second") : b / (1 * Q.minuteDuration) <= a ? (this.interval = 1, this.intervalType = "minute") : b / (2 * Q.minuteDuration) <= a ? (this.interval = 2, this.intervalType = "minute") : b / (5 * Q.minuteDuration) <= a ? (this.interval = 5, this.intervalType = "minute") : b / (10 * Q.minuteDuration) <= a ? (this.interval = 10, this.intervalType = "minute") : b / (15 * Q.minuteDuration) <= a ? (this.interval = 15, this.intervalType = "minute") : b / (20 * Q.minuteDuration) <= a ? (this.interval = 20, this.intervalType = "minute") : b / (30 * Q.minuteDuration) <= a ? (this.interval = 30, this.intervalType = "minute") : b / (1 * Q.hourDuration) <= a ? (this.interval = 1, this.intervalType = "hour") : b / (2 * Q.hourDuration) <= a ? (this.interval = 2, this.intervalType = "hour") : b / (3 * Q.hourDuration) <= a ? (this.interval = 3, this.intervalType = "hour") : b / (6 * Q.hourDuration) <= a ? (this.interval = 6, this.intervalType = "hour") : b / (1 * Q.dayDuration) <= a ? (this.interval = 1, this.intervalType = "day") : b / (2 * Q.dayDuration) <= a ? (this.interval = 2, this.intervalType = "day") : b / (4 * Q.dayDuration) <= a ? (this.interval = 4, this.intervalType = "day") : b / (1 * Q.weekDuration) <= a ? (this.interval = 1, this.intervalType = "week") : b / (2 * Q.weekDuration) <= a ? (this.interval = 2, this.intervalType = "week") : b / (3 * Q.weekDuration) <= a ? (this.interval = 3, this.intervalType = "week") : b / (1 * Q.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : b / (2 * Q.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : b / (3 * Q.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * Q.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * Q.yearDuration) <= a ? 1 : b / (2 * Q.yearDuration) <= a ? 2 : b / (4 * Q.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / Q.yearDuration), this.intervalType = "year"));
      ...
      if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
        ...
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) {
          if (b = 1 === r % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === r % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + r / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - r / 2 + 0.5 << 0, a *= -1), this.bounds = {
            ...
            x2: k + r / 2,
            y2: l
          }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(k, l), this.ctx.lineTo(k, e);else if ("wavy" === this.type) {
            m = b;
            h = e;
            f = 0.5;
            n = (l - h) / a / 3;
            ...
            for (var q = 0; q < n; q++) {
              this.ctx.bezierCurveTo(m + f * a, h + a, m + f * a, h + 2 * a, m, h + 3 * a), h += 3 * a, f *= -1;
            }
          ...
          for (q = 0; q < n; q++) {
            this.ctx.bezierCurveTo(m + a, h + f * a, m + 2 * a, h + f * a, m + 3 * a, h), m += 3 * a, f *= -1;
          }
    ...
    M.prototype.render = function () {
      ...
      if (0 < d) {
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, k = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = {
          x1: e - d / 2,
          y1: k,
          x2: f + d / 2,
          y2: l
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var w = 0; w < this.parent.dataSeries.length; w++) {
            (u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[w], null !== u.dataPoint.y && u.dataSeries.visible && n.push(u));
          }
          ...
          w = 0;
          if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[0])), t = 0, v = 0; v < n.length; v++) {
            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (var x = 0; x < n[v].dataPoint.y.length; x++) {
              t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
            } else t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y)), t < u && (u = t, w = v);
          } else if ("stackedBar" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = t = 0, v = w = 0; v < n.length; v++) {
            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) {
              t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
            } else y += n[v].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(y)), t < u && (u = t, w = v);
          } else if ("stackedBar100" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), C = y = t = 0, v = 0; v < n.length; v++) {
            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) {
              t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
            } else y += n[v].dataPoint.y, C = n[v].dataPoint.x.getTime ? n[v].dataPoint.x.getTime() : n[v].dataPoint.x, C = 100 * (y / n[v].dataSeries.plotUnit.dataPointYSums[C]), t = Math.abs(a - this.parent.convertValueToPixel(C)), t < u && (u = t, w = v);
          } else for (u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), v = w = t = 0; v < n.length; v++) {
            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) {
              t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
            } else t = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y)), t < u && (u = t, w = v);
          }
          ...
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
              ...
              for (v = t = 0; v < x.dataPoint.y.length; v++) {
                t = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[v])), t < u && (u = t, b = v);
              }
              ...
              for (v = w; 0 <= v; v--) {
                y += n[v].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(y)), t < u && (u = t, b = v);
              }
              ...
              for (v = w; 0 <= v; v--) {
                y += n[v].dataPoint.y, C = n[v].dataPoint.x.getTime ? n[v].dataPoint.x.getTime() : n[v].dataPoint.x, C = 100 * (y / n[v].dataSeries.plotUnit.dataPointYSums[C]), t = Math.abs(a - this.parent.convertValueToPixel(C)), t < u && (u = t, b = v);
              }
            ...
            } else l = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, h.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: c ? c : x.dataPoint.y
            ...
            C = !1;
            if (this.parent.labels) for (n = Math.ceil(this.parent.interval), v = 0; v < this.parent.viewportMaximum; v += n) {
              if (this.parent.labels[v]) C = !0;else {
                C = !1;
                break;
              }
            }
            ...
            if (C) {
              if ("axisX" === this.parent.type) for (v = this.parent.convertPixelToValue({
                y: d
              }), u = null, w = 0; w < this.parent.dataSeries.length; w++) {
                (u = this.parent.dataSeries[w].getDataPointAtX(v, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                  chart: this.chart,
                  axis: this.parent.options,
                  crosshair: this.options,
                  value: x.dataPoint.x
            ...
            }) : s(this.options.label) ? ya(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: c ? c : x.dataPoint.x
          ...
          !s(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (v = this.parent.dataSeries[0].axisX.convertPixelToValue({
            x: a
          }));
          ...
          w = 0;
          if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type) for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), v = t = 0; v < n.length; v++) {
            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) {
              t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
            } else t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y)), t < u && (u = t, w = v);
          } else if ("stackedColumn" === n[0].dataSeries.type || "stackedArea" === n[0].dataSeries.type) for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), v = y = t = 0; v < n.length; v++) {
            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) {
              t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
            } else y += n[v].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < u && (u = t, w = v);
          } else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type) for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), v = C = y = t = 0; v < n.length; v++) {
            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) {
              t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
          ...
          } else for (u = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), v = t = 0; v < n.length; v++) {
            if (n[v].dataPoint.y && n[v].dataPoint.y.length) for (x = 0; x < n[v].dataPoint.y.length; x++) {
              t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y[x])), t < u && (u = t, w = v);
            } else t = Math.abs(d - this.parent.convertValueToPixel(n[v].dataPoint.y)), t < u && (u = t, w = v);
          }
          ...
          if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
            ...
            for (v = t = 0; v < x.dataPoint.y.length; v++) {
              t = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[v])), t < u && (u = t, b = v);
            }
            ...
            for (v = w; 0 <= v; v--) {
              y += n[v].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(y)), t < u && (u = t, b = v);
            }
            ...
            for (v = w; 0 <= v; v--) {
              y += n[v].dataPoint.y, C = n[v].dataPoint.x.getTime ? n[v].dataPoint.x.getTime() : n[v].dataPoint.x, C = 100 * (y / n[v].dataSeries.plotUnit.dataPointYSums[C]), t = Math.abs(d - this.parent.convertValueToPixel(C)), t < u && (u = t, b = v);
            }
            ...
            this.value = C;
          } else "waterfall" === this.parent.dataSeries[w].type ? (m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0, h.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum
          }) : s(this.options.label) ? ea(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (m = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, h.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: x.dataPoint.y
        ...
        n = null;
        if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && h.y - h.fontSize / 2 < this.chart.bounds.y1 && (h.y = this.chart.bounds.y1 + h.fontSize / 2), "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - h.fontSize / 2 + h.measureText().height > this.chart.bounds.y2 && (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2), b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && (0 < r && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), this._hidden = !1), q.restore(), !s(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
        if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1), "right" === this.parent._position && h.x + h.measureText().width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.measureText().width), k >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < r && (q.moveTo(b, f), q.lineTo(e, k), q.stroke(), this._hidden = !1), q.restore(), !s(h.text) && ("number" === typeof h.text.valueOf() || 0 < h.text.length) && h.render(!0));
      } else {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          if ("left" === this.parent._position || "right" === this.parent._position) {
            ...
            }) : s(this.options.label) ? ya(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: c ? c : this.parent.convertPixelToValue(d)
          ...
          if (C) {
            ...
            crosshair: this.options,
            value: c ? c : this.parent.convertPixelToValue(a)
          }) : s(this.options.label) ? ya(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
    ...
    $.prototype._updateToolTip = function (a, d, c) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX) for (var m = 0; m < this.chart.axisX.length; m++) {
              for (var k = this.chart.axisX[m].convertPixelToValue({
                ...
                (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
              }
            ...
            if (this.chart.axisX2) for (m = 0; m < this.chart.axisX2.length; m++) {
              ...
              for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++) {
                (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
              }
            ...
            if (this.chart.axisX2) for (m = 0; m < this.chart.axisX2.length; m++) {
              for (k = this.chart.axisX2[m].convertPixelToValue({
                x: a
              }), h = null, b = 0; b < this.chart.axisX2[m].dataSeries.length; b++) {
                (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
              }
            }
          }
          ...
          if (h = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = h.dataPointIndex, this.currentSeriesIndex = h.dataSeries.index;else if (u) {
            if (h = Wa(a, d, this.chart._eventManager.ghostCtx), 0 < h && "undefined" !== typeof this.chart._eventManager.objectMap[h]) {
      ...
      for (c = 0; c < a.length; c++) {
        ...
        if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
          var b = this.chart.data[e.dataSeriesIndex],
              ...
              k = e.dataPointIndex;
          !1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled || ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "scatter" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type ? (f = b.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), X.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = b.getMarkerProperties(k, e.x1, e.y2, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), X.drawMarkers([f]))) : "bubble" === b.type ? (f = b.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = e.size, f.color = "white", f.borderColor = "white", d.globalAlpha = 0.3, X.drawMarkers([f]), d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ca(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? Y(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? oa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)), d.stroke(), d.beginPath(), d.moveTo(e.x3 - b, Math.max(e.y1, e.y4)), d.lineTo(e.x3 - b, Math.max(e.y2, e.y3)), d.stroke(), ca(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1) : "ohlc" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, e.y2), d.lineTo(e.x3 - b, e.y3), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y1), d.lineTo(e.x1, e.y1), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4), d.lineTo(e.x2, e.y4), d.stroke(), d.globalAlpha = 1) : "boxAndWhisker" === b.type ? (d.save(), d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), ca(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent", e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1, d.strokeStyle = e.whiskerColor, d.lineWidth = 2 * e.whiskerThickness, 0 < e.whiskerThickness && (d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y4), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y4), d.stroke(), d.beginPath(), d.moveTo(Math.floor(e.x3 - e.whiskerLength / 2), e.y1), d.lineTo(Math.ceil(e.x3 + e.whiskerLength / 2), e.y1), d.stroke()), d.globalAlpha = 1, d.strokeStyle = e.lineColor, d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === b.type && y(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
        }
      }
